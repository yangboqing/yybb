...
- (void)makeViews{
    ...
    UIImage * _image1 = [UIImage imageNamed:@"topVerticalLine.png"];
...
- (void)setFind_top_starScroll:(UIScrollView *)_scrollView{
    startContentOffsetX = _scrollView.contentOffset.x;
    
}
- (void)setFind_top_endScroll:(UIScrollView *)_scrollView{
    willEndContentOffsetX = _scrollView.contentOffset.x;

}
- (void)setFind_top_didEndScroll:(UIScrollView *)_scrollView{
   float endContentOffsetX = _scrollView.contentOffset.x;
    if (endContentOffsetX < willEndContentOffsetX && willEndContentOffsetX < startContentOffsetX) { //画面从右往左移动，前一页
        ...
        [_select setTitleColor: SELECTED forState:UIControlStateNormal];
        ...
        [_select setTitleColor: [UIColor blackColor] forState:UIControlStateNormal];
