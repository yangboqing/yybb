...
#define ACTIONSHEET_BACKGROUNDCOLOR             hllColor(246, 246, 246, 1.0)
...
#define CANCEL_BUTTON_COLOR                     hllColor(235, 235, 235, 1.0)

#define SHAREBUTTON_WIDTH                       50
#define SHAREBUTTON_HEIGHT                      50
#define SHAREBUTTON_INTERVAL_WIDTH              (([UIScreen mainScreen].bounds.size.width-SHAREBUTTON_WIDTH*3)*0.25)
#define SHAREBUTTON_INTERVAL_HEIGHT             35

#define SHARETITLE_WIDTH                        50
#define SHARETITLE_HEIGHT                       20
#define SHARETITLE_INTERVAL_WIDTH               (([UIScreen mainScreen].bounds.size.width-SHARETITLE_WIDTH*3)*0.25)
...
#define TITLE_WIDTH                             ([UIScreen mainScreen].bounds.size.width-TITLE_INTERVAL_WIDTH*2)
...
#define BUTTON_BORDER_COLOR                     hllColor(133, 133, 133, 0.8).CGColor
...
@property (nonatomic,weak) id<LXActivityDelegate>delegate;
...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle shareButtonTitles:(NSArray *)shareButtonTitlesArray withShareButtonImagesName:(NSArray *)shareButtonImagesNameArray
{
    ...
    if (cancelButtonTitle) {
        ...
        if (self.isHadTitle == YES || self.isHadShareButton == YES) {
            [cancelButton setFrame:CGRectMake(cancelButton.frame.origin.x, self.LXActivityHeight+20, cancelButton.frame.size.width, cancelButton.frame.size.height)];
            self.LXActivityHeight = self.LXActivityHeight + cancelButton.frame.size.height;//+BUTTON_INTERVAL_HEIGHT*2;
        }
...
- (UIButton *)creatCancelButtonWith:(NSString *)cancelButtonTitle
{
    ...
    cancelButton.frame = CGRectMake(0, BUTTON_INTERVAL_HEIGHT, self.frame.size.width, BUTTON_HEIGHT*2);
...
//    cancelButton.layer.cornerRadius = CORNER_RADIUS;
    ...
    [cancelButton setBackgroundColor:CANCEL_BUTTON_COLOR];
    [cancelButton setTitle:cancelButtonTitle forState:UIControlStateNormal];
    cancelButton.titleLabel.font = BUTTONTITLE_FONT;
    [cancelButton setTitleEdgeInsets:UIEdgeInsetsMake(-25, 0, 0, 0)];
    [cancelButton setTitleColor:[UIColor colorWithRed:22.0/255.0 green:124.0/255.0 blue:249.0/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (UILabel *)creatShareLabelWithColumn:(int)column andLine:(int)line
{
    ...
    shareLabel.textColor = hllColor(90, 90, 90, 1.0);
    return shareLabel;
}
...
- (UILabel *)creatTitleLabelWith:(NSString *)title
{
    ...
    titlelabel.textColor = hllColor(67, 67, 67, 1.0);
