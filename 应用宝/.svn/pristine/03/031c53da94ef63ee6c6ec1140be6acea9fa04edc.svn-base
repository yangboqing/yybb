...
@interface ResourceIPhoneBrowserViewController : UIViewController<RHomePageMainVCDelegate,ITransProxy,downAlertViewDelegate,UIAlertViewDelegate,lessonDelegate,requestRealtimeShowDelegate,AuthorizationDelegate,MumDelegate,AppidResultDeletate>{
