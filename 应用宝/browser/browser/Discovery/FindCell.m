...
-(void)setCustomFrame
{
    ...
    CGSize size = [_titleLabel.text boundingRectWithSize:CGSizeMake(titleWidth, 36) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:_titleLabel.font} context:nil].size;
