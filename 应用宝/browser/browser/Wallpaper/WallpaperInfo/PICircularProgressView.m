...
+ (void)initialize
{
    if (self == [PICircularProgressView class])
    {
        ...
        [appearance setThicknessRatio:0.17f];
        
        [appearance setInnerBackgroundColor:nil];
        [appearance setOuterBackgroundColor:[UIColor colorWithWhite:1.0f alpha:0.2]];
        
        [appearance setTextColor:[UIColor whiteColor]];
        [appearance setFont:[UIFont systemFontOfSize:10]];
        [appearance setProgressFillColor:[UIColor whiteColor]];
